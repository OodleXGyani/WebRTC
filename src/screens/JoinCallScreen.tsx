      ...
      >
        ...
        <View style={styles.headerTop}>
          <View style={styles.header}>
            <Text style={[styles.headerTitle, { color: colors.primary }]}>Join Call (Manual Mode)</Text>
        ...
        {/* Paste Offer Section */}
        <Section title="Step 1: Paste Offer">
          <Card>
            <Text style={[styles.stepDescription, { color: colors.textSecondary }]}>
              Paste the offer from the person calling you
            </Text>
            <TextInput
        ...
        {/* Answer Display */}
        {answer && (
          <Section title="Your Answer (Share This)">
            <Card>
              <View style={styles.copyRow}>
                <Text style={[Typography.caption, { color: colors.textSecondary }]}>
                  Copy and send this to the caller
                </Text>
                <TouchableOpacity
        ...
        <Section title={`Step 2: ICE Candidates (${iceCandidates.length})`}>
          <Card>
